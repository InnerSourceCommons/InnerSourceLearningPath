...
Se non ottieni quello di cui hai bisogno, puoi approntare le modifiche richieste direttamente nel repository del codice dell'altro team agendo come un Contributore InnerSource.
