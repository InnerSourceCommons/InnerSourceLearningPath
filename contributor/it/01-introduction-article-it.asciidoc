...
Infine, alcuni di loro possono diventare https://innersourcecommons.org/learn/learning-path/trusted-committer/01[Trusted Committers].

=== Relazione con gli altri ruoli

Come Contributore all'interno di una comunità InnerSource andrai ad interagire con persone che ricoprono altri ruoli InnerSource, come il https://innersourcecommons.org/learn/learning-path/trusted-committer/01[_Trusted Committer_] o il https://innersourcecommons.org/learn/learning-path/product-owner/01[_Product Owner_] e possibilmente con altri contributori.
...
Il ruolo del https://innersourcecommons.org/learn/learning-path/product-owner/01[_Product Owner_] ha qualche somiglianza con il ruolo del product owner del tuo progetto di media dimensione.
