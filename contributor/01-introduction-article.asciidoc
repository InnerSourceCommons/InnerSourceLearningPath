...
Finally, some of them may become https://innersourcecommons.org/learn/learning-path/trusted-committer/01[Trusted Committers].

=== Relationship to other roles

As a Contributor in an InnerSource community you will interact with people playing other roles of InnerSource, such as https://innersourcecommons.org/learn/learning-path/trusted-committer/01[_Trusted Committer_] or https://innersourcecommons.org/learn/learning-path/product-owner/01[_Product Owner_] and possibly with other contributors.
...
The role of the https://innersourcecommons.org/learn/learning-path/product-owner/01[_Product Owner_] has some similarity with the product owner role of your average project.
...
If you want to learn in more detail what these other roles are about, and we encourage you to do so, we've prepared separate sections about the https://innersourcecommons.org/learn/learning-path/trusted-committer/01[_Trusted Committer_] and the https://innersourcecommons.org/learn/learning-path/product-owner/01[_Product Owner_].
