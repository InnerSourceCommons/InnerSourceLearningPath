...
One approach is to just quickly react with a "I'll look into it, I won't get to it in the next few days though" to a https://innersourcecommons.org/learn/learning-path/trusted-committer/01[_Trusted Committer's_] feedback if you know that you'll only be able to come back to them in a few days.
...
It's best to ask a https://innersourcecommons.org/learn/learning-path/trusted-committer/01[_Trusted Committer_] about how to best discuss your proposal.
...
Here's what you can do to make reviewing and merging as easy as possible for the the https://innersourcecommons.org/learn/learning-path/trusted-committer/01[_Trusted Committer_] and the host team.
...
The basic point here is to enable the https://innersourcecommons.org/learn/learning-path/trusted-committer/01[_Trusted Committer_] to validate the contribution without your presence and to ensure easy maintainability.
 ...
 ** Be civil and expect civility from the https://innersourcecommons.org/learn/learning-path/trusted-committer/01[_Trusted Committer's_] review.
