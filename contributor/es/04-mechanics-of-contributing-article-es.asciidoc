...
¿Está preparado para empezar a contribuir a los proyectos/repositorios de otros equipos?
¿Desea reducir sus bloqueos no por medio de la gestión sino por medio de la colaboración?
En esta sección se ofrecen consejos prácticos y se destacan los puntos que hay que recordar al realizar una contribución en InnerSource. Permite que usted y el equipo anfitrión tengan una experiencia lo más agradable posible, sentando las bases para más contribuciones y una gran colaboración.

Este artículo se divide en los tres pasos que probablemente experimentará

* <<preparación-para-el-trabajo, solicitando su oportunidad de contribución y preparándose para trabajar en ella>>
...
Si tu contribución es más grande, posiblemente pasarás por (algunos) de estos pasos repetidamente mientras iteras hacia tu objetivo común.
...
A menudo, notará una reducción en el tiempo de entrega por equipo anfitrión después de hacer algunas contribuciones exitosas a ese equipo anfitrión.
Este efecto puede observarse también en el código abierto, puede leer más sobre ello <<construcción de confianza a través de la colaboración, aquí>>.
...
Este tipo de acuerdo inicial de alto nivel le ahorrará tiempo en la reelaboración o el rechazo de su solicitud de extracción en el futuro.
...
Todos tenemos nuestras preferencias y opiniones sobre el estilo del código, la sangría, etc.
...
* Intenta evitar commits supergrandes, commits con mensajes de commit poco claros, gazillones de archivos, cambios incoherentes (por ejemplo, que toquen varios temas).
 ...
 ** Sea civilizado y espere civismo de la revisión de https://innersourcecommons.org/learn/learning-path/trusted-committer[_Trusted Committer_].
 ...
 ** Si usted tiene una característica más grande que está contribuyendo, a menudo ayuda a dividirla en múltiples solicitudes de extracción que se envían, revisan y aceptan secuencialmente.
Usted todavía puede unirse a ellos con una cuestión que se refiere.
  *** Algunas herramientas también tienen la funcionalidad de solicitud de extracción de borrador / WIP que puede utilizar para marcar explícitamente el trabajo inacabado y no pulido y aún así obtener retroalimentación temprana de su equipo anfitrión https://innersourcecommons.org/learn/learning-path/trusted-committer/02/[_Trusted Committer_].
  *** Esto le permite asegurarse de que va por un camino que su equipo anfitrión está feliz de fusionar una vez que está hecho, adhiriéndose a la idea de "liberar temprano, liberar a menudo" en cierto modo.
