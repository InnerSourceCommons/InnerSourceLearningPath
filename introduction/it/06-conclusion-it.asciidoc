...
L'InnerSource di successo coinvolge un https://innersourcecommons.org/learn/learning-path/product-owner[_product owner_] e un https://innersourcecommons.org/learn/learning-path/trusted-committer[_trusted committer_] dell'*host team* così come un https://innersourcecommons.org/learn/learning-path/contributor[_contributor_] del *guest team*.
