...
En plus de cet alignement, il y a également une formation générale et une éducation des https://innersourcecommons.org/learn/learning-path/contributor[contributeurs] car ils travaillent avec et apprennent du https://innersourcecommons.org/learn/learning-path/trusted-committer[committer de confiance].
