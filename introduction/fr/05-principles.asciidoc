...
Le mentorat de l'équipe hôte vers l'équipe invitée par les https://innersourcecommons.org/learn/learning-path/trusted-committer/01[committers de confiance] est un aspect essentiel de l'InnerSource.
