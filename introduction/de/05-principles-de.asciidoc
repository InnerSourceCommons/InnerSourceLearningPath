...
_Mentorship_ vom Hostteam zum Gastteam durch https://innersourcecommons.org/learn/learning-path/trusted-committer/01[Trusted Committers] ist ein Schlüsselaspekt von InnerSource.
https://innersourcecommons.org/learn/learning-path/contributor/01[Contributors] in Gastteams sind auf dem neuesten Stand, sodass sie genug über das Projekt / Repo des Host-Teams wissen um es erfolgreich verändern zu können.
