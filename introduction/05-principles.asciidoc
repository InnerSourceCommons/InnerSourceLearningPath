...
_Mentorship_ from host team to guest team via https://innersourcecommons.org/learn/learning-path/trusted-committer/01[trusted committers] is a key aspect of InnerSource.
https://innersourcecommons.org/learn/learning-path/contributor/01[Contributors] on guest teams are upleveled so that they understand enough about the host team's project/repo to change it successfully.
