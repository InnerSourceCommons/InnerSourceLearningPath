...
See the links below.
It helps to be familiar with the Agile or Lean processes, and it's really important that you understand the roles of the https://innersourcecommons.org/learn/learning-path/trusted-committer/01[_Trusted Committers_] and the https://innersourcecommons.org/learn/learning-path/contributor/01[_Contributors_] before watching this video. Thank you.
