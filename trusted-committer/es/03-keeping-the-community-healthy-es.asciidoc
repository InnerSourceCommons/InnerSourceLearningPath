...
Vamos a discutir esto con mayor profundidad en https://innersourcecommons.org/es/learn/learning-path/trusted-committer/04/["Subiendo de nível a la comunidad"].
...
Vamos a entrar en más detalle de esto en la sección https://innersourcecommons.org/es/learn/learning-path/trusted-committer/06/["Abogar por las necesidades de la comunidad"].
