...
Die Aufgabe eines _Trusted Committer_ ist es, die Qualitätsstandards innerhalb ihrer _Community_ zu kommunizieren und zu erläutern, vor allem sie so zu formulieren, dass sie für ihre https://github.com/InnerSourceCommons/InnerSourceLearningPath/blob/master/contributor/01-introduction-article.asciidoc[_Contributors_] verständlich und anwendbar sind. 
