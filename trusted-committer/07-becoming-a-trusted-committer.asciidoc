...
As a community grows, or in larger communities, Trusted Committers are usually nominated or voted in from the community https://innersourcecommons.org/learn/learning-path/contributor/01[contributors].
...
What are the criteria to apply in nominating https://innersourcecommons.org/learn/learning-path/contributor/01[contributors] for a Trusted Committer role? 
