...
and important. Let’s start with the https://innersourcecommons.org/learn/learning-path/contributor/01[_Contributor_] role. A
...
The https://innersourcecommons.org/learn/learning-path/product-owner/01[_Product Owner_ (PO)] is the third role in InnerSource. Similar to
...
acts as a PO. Check out our https://innersourcecommons.org/learn/learning-path/product-owner/01[Product Owner Learning Path segment]
