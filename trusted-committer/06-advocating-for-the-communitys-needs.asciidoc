...
Trusted Committers also need to make sure that the community and individual https://innersourcecommons.org/learn/learning-path/contributor/01[contributors] get public credit for their work. 
...
Another common case calling for the Trusted Committer’s advocacy is when  https://innersourcecommons.org/learn/learning-path/contributor/01[contributors] are not given time or permission to contribute. 
...
In summary, there are many situations in which Trusted Committers need to advocate for the interests of individual https://innersourcecommons.org/learn/learning-path/contributor/01[contributors] and for the community as a whole. 
