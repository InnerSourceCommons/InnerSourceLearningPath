...
https://innersourcecommons.org/learn/learning-path/contributor[_コントリビューター_] の役割から始めましょう。
...
https://innersourcecommons.org/learn/learning-path/product-owner[_プロダクトオーナー_ (PO)]は、InnerSourceにおける3番目の役割です。
...
より詳細については、 https://innersourcecommons.org/learn/learning-path/product-owner[ラーニングパスのプロダクトオーナーセグメント] を確認してください。
