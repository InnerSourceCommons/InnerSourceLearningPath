...
The TC role is a very demanding but at the same
time very fulfilling role. If this learning path has interested you in the role of a TC, you
...
product owners and with management, as that's a key part of the TC role.
...
tell you, explaining something to someone else, in the TC's case
explaining to contributors how the software works, more often than not leads to
new insights on part of the TC and will help to identify opportunities to
...
where multiple TCs share the workload of the TC role and the TCs who are not _on
